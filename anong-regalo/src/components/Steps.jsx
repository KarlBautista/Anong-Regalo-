    ...
    <section className='w-full h-[150px] flex justify-center mt-10 px-3'>
        <div className='w-full h-full md:w-[40%] flex items-center  justify-center px-2'>
            <div className='flex flex-col items-center gap-2 '>
                <div className='w-[40px] h-[40px] md:w-[50px] md:h-[50px] bg-gray-200 rounded-full flex justify-center items-center text-1xl  text-[#D32F2F] border-2 border-[#D32F2F]'>1</div>
            ...
            <div className='flex flex-col items-center gap-2 '>
                <div className='w-[40px] h-[40px] md:w-[50px] md:h-[50px] bg-gray-200 rounded-full flex justify-center items-center text-1xl '>2</div>
                <p className='text-1xl '>Person</p>
            </div>  
